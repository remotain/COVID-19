...
m <- reactive({
  ...
  # Popup text
  mytext <- paste("Country: ", data$`Country/Region`, "<br/>", "Population: ", format(data$`Population`, format="d", big.mark="'"), "<br/>", "Confirmed: ", sprintf("%.2f", data$`Confirmed`), "<br/>", "Recovered: ", sprintf("%.2f", data$`Recovered`), "<br/>", "Deaths: ", sprintf("%.2f", data$`Deaths`), sep="") %>%
